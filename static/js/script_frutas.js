...
// === PREENCHE TABELA TOP5 DUPLICADA ===
const tbodyTop5Duplicado = document.getElementById('tableTop5Duplicado');
if (dados.top5 && Array.isArray(dados.top5)) {
    tbodyTop5Duplicado.innerHTML = ''; // Limpa conteúdo anterior
    ...
    dados.top5.forEach(r => {
        ...
        tr.innerHTML = `
            ...
            <td><span class="status-indicator ${statusClass}">${statusIcon}</span></td>
        `;
        tbodyTop5Duplicado.appendChild(tr);
    });
}
