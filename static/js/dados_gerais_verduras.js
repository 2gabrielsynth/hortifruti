...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Dados Gerais Verduras - Inicializando...');
    ...
    if (ctx) {
        ctx.parentElement.innerHTML = `
            <div style="text-align: center; padding: 3rem; color: var(--text-tertiary);">
                ...
                <small>Mostrando variações individuais dos verduras</small>
            </div>
        `;
    }
}
...
function exportData() {
    try {
        ...
        link.setAttribute('download', 'dados_gerais_verduras.csv');  // ← MUDANÇA AQUI
...
function downloadChart() {
    ...
    const link = document.createElement('a');
    link.download = 'grafico_performance_verduras.png';  // ← MUDANÇA AQUI
